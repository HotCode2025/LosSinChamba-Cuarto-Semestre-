...
public class EstudiantesApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		while (!salir){
			...
			// INICIO DE EXCEPCIÓN: Atrapa errores si el usuario ingresa letras en vez de números
			try {
				salir = ejecutarOpciones(consola);
			} catch (Exception e) {
				logger.info(nl + "Error: ¡Entrada inválida! Por favor, ingrese un número entero." + nl);
				// Esta línea limpia la consola para que el programa no entre en un bucle infinito
				consola.nextLine();
			}
			// FIN DE EXCEPCIÓN
